  ...
  return (
      <div className="mt-24">
        <div className="flex flex-wrap justify-center lg:flex-nowrap ">
          <div className="w-full p-8 m-3 bg-white bg-center bg-no-repeat bg-cover h-44 rounded-xl lg:w-80 pt-9 bg-hero-pattern">
            ...
            <div className="mt-2">
              ...
              <div className="flex gap-4">
                {medicalproBranding.leaders.map((item, index) => (
                    <Image key={index} className="rounded-full w-8 h-8" src={item.image} alt="" width="50px" height="50px" />
                ))}
              </div>
            </div>
            <div className="flex justify-between items-center mt-5 border-t-1 border-color">
